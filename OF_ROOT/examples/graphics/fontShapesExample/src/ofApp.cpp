...
void ofApp::setup(){
	...
	testFont.load("arial.ttf", 160, true, true, true);
	testFont2.load("cooperBlack.ttf", 52, true, true, true);
    juni.load("junicode.ttf", 16, true, true, true);
...
//	ofEndShape(true);
//
	ofDrawBitmapString("ᚠᚢᚦᚬᚱᚴᚼᚾᛁᛅᛋᛏᛒᛘᛚᛦ", 10, 10);
	ofDrawBitmapString("press a key to see it as a texture and as a vector. ", 10, 24);

	testFont2.drawString("Hello - I am bitmap", 15, 400);

	ofFill();
	testFont2.drawStringAsShapes("Hello - I ᚠᚢᚦᚬᚱᚴᚼᚾᛁᛅᛋᛏᛒᛘᛚᛦam vector", 15, 480);
    juni.drawString("testin ᚠᚢᚦᚬᚱᚴᚼᚾᛁᛅᛋᛏᛒᛘᛚᛦ", 50, 50);
    
	ofNoFill();
	testFont2.drawStringAsShapes("Heᚠᚢᚦᚬᚱᚴᚼᚾᛁᛅᛋᛏᛒᛘᛚᛦllo - I am vector", 15, 550);
